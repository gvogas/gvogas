...
I am a Computer Science student at Vanier College with a focus on building real, functional applications using modern programming languages, frameworks, and databases.

---

## 👨‍💻 Focus

Strong foundation in object-oriented programming, web development, and database-driven applications.  
Hands-on experience developing full-stack web apps and desktop software using Java, C#, JavaScript, and SQL.

---

### Areas of Study & Experience
- Software Development (Java, C#)
- Web Development (HTML, CSS, JavaScript, PHP, jQuery)
- Database Design & Administration (SQL, MySQL, phpMyAdmin)
- App Development for Android and Windows
- Unix / Linux systems usage and scripting
